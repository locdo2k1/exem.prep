                ...
                List<QuestionResultVM> directQuestions = test.getTestQuestionDetails().stream()
                                ...
                                .map(detail -> {
                                        ...
                                        return QuestionResultVM.builder()
                                                        ...
                                                        .correctOptions(question.getOptions() != null ? question
                                                                        .getOptions().stream()
                                                                        .filter(Option::isCorrect)
