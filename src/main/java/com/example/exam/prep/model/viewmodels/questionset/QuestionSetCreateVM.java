...
/**
 * View model for creating a new question set.
 * Supports form-data for file uploads.
 */
@Data
public class QuestionSetCreateVM {
    ...
    /**
     * List of question IDs to be associated with this question set.
     * Must not be empty and each element must be positive.
     */
    @NotBlank(message = "At least one question ID is required")
     ...
     * Each file must be under 10MB and be an audio file.
     */
    @Size(max = 5, message = "Maximum 5 audio files allowed")
    @Valid
    private List<@NotNull(message = "Audio file cannot be null") MultipartFile> audioFiles;
